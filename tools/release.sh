...
zip -r -X dist/shmup_deck.zip shmup_deck -x "*/__pycache__/*" "*.DS_Store" "*/art/*" "*mra_index*.json" "*plays.json" "*favourites.json" "*versions.json" "*decks.json" "*.migrated" >/dev/null
